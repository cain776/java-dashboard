...
import { WeeklyReportPage } from './pages/report/ReportPage'
import { MonthlyReportPage } from './pages/report/MonthlyReportPage'
import { OverallExamPage } from './pages/overall/OverallExamPage'
import { OverallExamWeeklyPage } from './pages/overall/OverallExamWeeklyPage'
import { IntakeConversionPage } from './pages/reservation/IntakeConversionPage'
import { ReservationPage } from './pages/reservation/ReservationPage'
import { ReservationOverallPage } from './pages/reservation/ReservationOverallPage'
...
import { ExaminationVisionPage } from './pages/exam/ExaminationVisionPage'
import { ExaminationDreamlensPage } from './pages/exam/ExaminationDreamlensPage'
import { ProcedureExamPage } from './pages/exam/ProcedureExamPage'
import { ExamListPage } from './pages/exam/ExamListPage'
import { CataractExamListPage } from './pages/exam/CataractExamListPage'
import { ConsultationRatePage } from './pages/consultation/ConsultationRatePage'
import { CataractReservationRatePage } from './pages/consultation/CataractReservationRatePage'
import { StopReasonPage } from './pages/consultation/StopReasonPage'
import { SurgeryListPage } from './pages/surgery/SurgeryListPage'
import { SurgeryPage } from './pages/surgery/SurgeryPage'
import { SurgeryRatioPage } from './pages/surgery/SurgeryRatioPage'
import { SurgeryCompositionPage } from './pages/surgery/SurgeryCompositionPage'
import { OutpatientCountPage } from './pages/outpatient/OutpatientCountPage'
import { OverseasPage } from './pages/marketing/OverseasPage'
import { MarketingPage } from './pages/marketing/MarketingPage'
import { CancelRatePage } from './pages/cancel-noshow/CancelRatePage'
import { NoShowRatePage } from './pages/cancel-noshow/NoShowRatePage'
import { UnitPricePage } from './pages/unit-price/UnitPricePage'
