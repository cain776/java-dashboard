 ...
 * 시력교정(EXAM)·백내장 모두 사람 단위. 백내장은 레거시 BCRM 백내장_검사와 동일(RESERVATION FLAG='H', JINRYO='1').
 * 시력교정 검사유입은 종합지표(사람)와 정합. 전 컬럼 문자열.
 *   examGroup: 시력교정/드림렌즈/백내장 · introType: 일반/고객소개/직원소개 · jobBucket: 직장인/학생/기타
 */
