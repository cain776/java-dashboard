...
public class MockConsultationRateRepository {
    ...
    private static final String MONTHLY_BY_YEARS_SQL = "sql/mock/consultation/monthly-by-years.sql";
    private static final String KPI_BY_YEARS_SQL = "sql/mock/consultation/kpi-by-years.sql";
